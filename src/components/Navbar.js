...
const Navbar = () => {
    return (
        <>
            <div className=' lg:fixed z-50 bg-background fixed w-screen lg:h-[6.3%] border-b-[0.5px] border-zinc-700 text-white flex lg:justify-center justify-between items-center'>
